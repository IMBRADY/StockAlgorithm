...
def screen_stock(ticker, historical_client):
    try:
        ...
        atr = daily_range.tail(14).mean() # mean of high-low
        ...
        try: # catch general errors without killing whole bot
            ...
            for ticker in tickers:
                try:
                    ...
                    #MACD Buy
                    if current_macd > current_signal and current_macd > 0 and (current_macd-previous_macd) > 0 and new_data["close"] > ema30.iloc[-1] and volume_confirmed and not in_cooldown and not positions[ticker] and risk_per_trade > 0:
                    ...
                    #Stop Loss (Trailing Stop)
                        ...
                        if current_price < highest_prices[ticker]*0.99:
                            action = True
